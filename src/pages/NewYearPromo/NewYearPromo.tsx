    ...
    <div className={styles['new-year-promo-wrapper']}>
      ...
      <div className={`${styles['new-year-promo']} container`}>
        ...
        <p className={styles['disclaimer']}>
          Акция действует с 16 декабря 2024 года по 5 января 2025 года
          ...
          указанием промокода NewYearNordicSolar2025. Минимальная сумма
          пополнения для участия в акции — 50$. Бонус может быть выведен после
          того, как сумма пополненного депозита полностью отработает в рамках
          инвестиций на платформе. При отмене пополнения или попытке нарушения
          условий акции бонус будет аннулирован. Полученный бонус доступен для
          вывода вместе с доходом после завершения всех условий инвестирования.
          Участник акции обязан соблюдать Правила пользования платформой и
          Политику конфиденциальности, доступные по ссылкам на сайте.
          Организатор акции оставляет за собой право изменять условия, сроки
          проведения или прекращать акцию досрочно без предварительного
          уведомления.
        </p>
