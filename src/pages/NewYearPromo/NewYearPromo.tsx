  ...
  return (
    <div className={`${styles['new-year-promo']} container`}>
      ...
      <p className={styles['disclaimer']}>
        ...
        Максимальный бонус на одного пользователя неограничен. Бонус начисляется
        автоматически после успешного пополнения личного счета с указанием
        промокода NewYearNordicSolar2025. Минимальная сумма пополнения для
        участия в акции — 50$. Бонус может быть выведен после того, как сумма
        пополненного депозита полностью отработает в рамках инвестиций на
        платформе. При отмене пополнения или попытке нарушения условий акции
        бонус будет аннулирован. Полученный бонус доступен для вывода вместе с
        доходом после завершения всех условий инвестирования. Участник акции
        обязан соблюдать Правила пользования платформой и Политику
