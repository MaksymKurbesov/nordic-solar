  ...
  return (
    <div className={`${styles['terms-of-use']} container`}>
      ...
      <div>
        ...
        <p>
          We are Nordic Solar ("Company," "we," "us," "our"), a company
          registered in Norway Oslo, Lilleakerveien 14 P.O Box 200 Lilleaker
          NO-0216.
        </p>
        <p>
          We operate the website https://nordic-solar.tech (the{' '}
        ...
        <p>
          Specialists in investments in green energy solutions. We offer
          high-quality services, a personalized approach, and access to the
          latest renewable energy projects for your investment portfolio.
          Contact us today!
        </p>
        <p>
          You can contact us by phone at +35722761795, email at
          support@nordic-solar.tech, or by mail to Norway Oslo, Lilleakerveien
          14 P.O Box 200 Lilleaker NO-0216.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (
          <strong>"you"</strong>), and Nordic Solar, concerning your access to
        ...
        <p>
          ...
          upon posting or notifying you by support@nordic-solar.tech, as stated
      ...
      <div>
        ...
        <p>
          ...
          please address your request to: support@nordic-solar.tech. If we ever
      ...
      <div>
        ...
        <p>
          ...
          are hosted in Norway. If you access the Services from any other region
          ...
          Norway, then through your continued use of the Services, you are
          transferring your data to Norway, and you expressly consent to have
          your data transferred to and processed in Norway.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          ...
          of Norway, and the use of the United Nations Convention of Contracts
          ...
          provisions of the law in your country to residence. Nordic Solar and
          yourself both agree to submit to the non-exclusive jurisdiction of the
          courts of Nicosia, which means that you may make a claim to defend
      ...
      <div>
        ...
        <p>
          ...
          arbitration shall be Nicosia, Norway. The language of the proceedings
