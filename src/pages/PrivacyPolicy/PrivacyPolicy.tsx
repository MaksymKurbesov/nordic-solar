...
const PrivacyPolicy = () => {
  return (
    <div className={`${styles['privacy']} container`}>
      ...
      <div>
        This privacy notice for Nordic Solar
        <strong>("we," "us," or "our")</strong>, describes how and why we might
        ...
        <strong>support@nordic-solar.tech</strong>.
      </div>
      <div>
        ...
        <br /> <br /> Want to learn more about what we do with any information
        we collect?
      </div>
      <div>
        ...
        <br /> <br /> Like many businesses, we also collect information through
      ...
      <div>
        ...
        situations:<strong>Business Transfers.</strong> We may share or transfer
      ...
      <div>
        ...
        purposes that are described in this privacy notice or that are otherwise
        made clear to you on the relevant Services. Please note that we do not
      ...
      <div>
        <h2>10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>Most web browsers and
      ...
      <div>
        <h2>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>If you have
        questions or comments about this notice, you may email us at{' '}
        <strong>support@nordic-solar.tech</strong> or contact us by post at:
        <strong>
          Norway Oslo, Lilleakerveien 14 P.O Box 200 Lilleaker NO-0216
        </strong>
      </div>
      <h2>
