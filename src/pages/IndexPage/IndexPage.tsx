...
const FEATURES = [
  {
    ...
    description: ["Прямые инвестиции в проекты по возобновляемым источникам энергии",
  ...
  },
  {
    ...
    description: ["Анализ рынка зеленой энергетики и оценка перспективных проектов.",
  ...
  },
  {
    ...
    description: ["Полный цикл управления проектами от начальной идеи до завершения строительства и ввода в эксплуатацию",
  ...
  },
  {
    ...
    description: ["Исследования и разработки новых технологий в области возобновляемой энергии.",
