...
export const PRODUCTS = [
  ...
  },
  {
    ...
    questions: [ {
      ...
      "answer": "Водород можно производить с использованием разных технологий, включая электролиз воды, реформинг метана и биохимические процессы. Каждый метод имеет свои преимущества и недостатки в плане стоимости, экологической чистоты и масштабируемости."
    },
      {
        "title": "Насколько безопасно использование водорода в качестве топлива?",
        "answer": "Водород — это высокоэнергетичное топливо, но его хранение и транспортировка могут быть сложными из-за его взрывоопасности и низкой плотности. Современные технологии включают использование композитных баллонов и специальные меры безопасности, чтобы снизить риски."
      },
      {
        "title": "Может ли водород заменить традиционные виды топлива?",
        "answer": "Водород рассматривается как перспективная замена ископаемых видов топлива благодаря отсутствию выбросов углекислого газа при его сгорании. Однако широкомасштабное внедрение водородных технологий требует решения вопросов с инфраструктурой, стоимостью производства и устойчивым источником энергии для его производства."
      }]
  },
  {
    ...
    questions: [{
      ...
      "answer": "Эффективность ветровых турбин зависит от скорости и стабильности ветра, высоты установки и дизайна лопастей. Размещение турбин в местах с постоянными ветровыми потоками значительно повышает их производительность."
    },
      {
        "title": "Какие виды ветровых турбин существуют?",
        "answer": "Существуют горизонтально-осевые и вертикально-осевые турбины. Горизонтально-осевые наиболее распространены и эффективны для больших ветропарков, тогда как вертикально-осевые имеют преимущества при установке в городских условиях из-за меньшего шума и компактности."
      },
      {
        "title": "Как влияют ветровые турбины на окружающую среду?",
        "answer": "Ветровые турбины являются экологически чистым источником энергии, однако они могут оказывать влияние на местные экосистемы, включая изменение маршрутов миграции птиц и изменение ландшафта. Важно учитывать эти факторы при проектировании и строительстве ветропарков."
      }]
  },
  {
    ...
    link: "hydro-energy",
    questions: [ {
      "title": "Какие преимущества имеют гидроэлектростанции по сравнению с другими видами генерации энергии?",
      "answer": "Гидроэлектростанции обеспечивают стабильный и предсказуемый источник энергии, не зависящий от погодных условий. Они имеют высокий коэффициент полезного действия и могут служить резервными источниками в энергосистемах благодаря возможности быстро наращивать мощность."
    },
      {
        "title": "Какие экологические последствия связаны с строительством гидроэлектростанций?",
        "answer": "Строительство плотин и водохранилищ для гидроэлектростанций может изменить экосистемы рек, повлиять на миграцию рыб и привести к затоплению больших площадей. Это требует тщательной оценки экологического воздействия и разработки мер по минимизации негативных последствий."
      },
      {
        "title": "Насколько надежны гидроэлектростанции в условиях изменения климата?",
        "answer": "Изменение климата может повлиять на количество осадков и уровень рек, что в свою очередь скажется на работе гидроэлектростанций. Регулирование водных потоков и управление водохранилищами становится критически важным для поддержания устойчивой выработки энергии в меняющихся климатических условиях."
      }]
  },
];
